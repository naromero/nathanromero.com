...
Webflow.require('ix').init([
  {"slug":"slow-intro","name":"Slow Intro","value":{"style":{"opacity":0},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"opacity 2000ms ease-out 0, transform 4000ms ease-out 0"}],"stepsB":[]}]}}
]);
